...
import com.erickbonifacio.workshopmongo.dto.AuthorDTO;
import com.erickbonifacio.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		userRepository.saveAll(Arrays.asList(maria, alex, bob)); //salva antes pois, se nao, id fica null
